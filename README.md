...
```
cd existing_repo
git remote add origin https://git.gccis.rit.edu/2241-swen-344-01/client-group-11/client-awg8127.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.gccis.rit.edu/2241-swen-344-01/client-group-11/client-awg8127/-/settings/integrations)
